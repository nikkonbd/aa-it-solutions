...
const Categories = () => {
  return (
    <div className="bg-[#f0f7ff]">
      <div className="pt-20">
        <p className="text-center text-[#73d8ba]">OUR CATEGORY</p>
      ...
      <div className="grid grid-cols-1 px-4 md:px-0 sm:grid-cols-2 md:pb-24  md:grid-cols-4 gap-4 md:max-w-6xl lg:max-w-7xl mx-auto py-10">
        ...
        <div>
          ...
          <h2 className="text-2xl font-bold text-center pt-2">Development</h2>
        </div>
        <div>
          <img className="w-full shadow-md transition duration-300 ease-in-out hover:scale-90" src={image3} alt="" />
          <h2 className="text-2xl font-bold text-center pt-2">Marketing</h2>
        </div>
        <div>
