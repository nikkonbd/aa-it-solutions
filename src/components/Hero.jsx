...
const HomeHero = () => {
    return (
        <div className='md:flex md:max-w-6xl lg:max-w-7xl  mx-auto py-4 md:py-24 justify-between items-center gap-6'>
            <div className='px-4 md:px-0'>
            <h2 className='text-3xl font-semibold md:text-6xl md:font-bold pb-4'><span className='text-[#119fc6]'>Drive Customers Through</span> Digital Channels.</h2>
