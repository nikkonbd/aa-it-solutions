...
const AddCard = () => {
    return (
        <div className='bg-[#f0f7ff]'>
            <div className='py-24'>
                <p  className='text-center text-[#0dcaf0]'>OUR SERVICE</p>
                <h2 className='text-5xl text-center font-bold text-[#03112d]'>Services to help your <br /> business drive success</h2>
            </div>
            <div className='md:grid px-4 md:pb-24 md:px-0 sm:grid-cols-2 md:grid-cols-3 gap-6 md:max-w-6xl mx-auto'>
                <div className="card mb-6 md:mb-0 w-full bg-base-100">
                    ...
                    <div className="card-body items-center">
                        <h2 className="card-title text-[#03112d]">Digital Marketing</h2>
                ...
                <div className="card mb-6 md:mb-0 w-full bg-base-100">
                    ...
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-[#03112d]">Graphics Design</h2>
                        <div className='text-left py-3'>
                ...
                <div className="card w-full bg-base-100">
                    ...
                    <div className="card-body items-center text-center">
                        <h2 className="card-title text-[#03112d]">Web-Design & Development</h2>
                        <div className='text-left py-3'>
